/**
 * Utility functions for text processing and splitting
 */

/**
 * Split a sentence into two parts at the midpoint of its words
 * @param sentence The sentence to split
 * @returns A tuple of [first half, second half]
 */
...
/**
 * Split text into logical segments using various rules
